...
balance = 1000
balance += 7000 
print("Saldo z pensją: ", str(balance))
balance -= 2000
print("Saldo po opłaceniu kosztów mieszkania:", str(balance))
balance *= 3 
print("Saldo po błędzie banku:", str(balance))
balance -= 4000 
print("Saldo po kupieniu komputera:", str(balance))
balance = ((balance + 4000) / 3 ) - 4000
print("Saldo po poprawieniu błędu banku:", str(balance))